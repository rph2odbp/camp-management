  ...
  return (
    <div>
      ...
      >
        <Link
          to="/"
          style={{ fontWeight: 'bold', fontSize: '1.3rem', color: '#333', textDecoration: 'none' }}
        >
          Camp Management
        </Link>
  ...
  return (
    <section style={{ padding: '2rem', maxWidth: '400px', margin: '0 auto', textAlign: 'center' }}>
      ...
      <p style={{ marginTop: '2rem' }}>
        After login, you'll be redirected to your portal.
        <br />
        <Link to={from}>Return to previous page</Link>
      </p>
      <p style={{ color: '#999', fontSize: '0.9rem', marginTop: '2rem' }}>
        * Your role will be assigned by camp administrators. If you don't have access, please
        contact support.
      </p>
    </section>
  );
